...
func UpdateAllTokens(signedToken string, signedRefreshToken string, userId int) {

	var getUser models.User
	db.Where("ID=?", userId).Find(&getUser)
	db.Model(&getUser).Updates(models.User{Token: signedToken, Refresh_Token: signedRefreshToken})
